...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Pioneer Power System Brand Colors - Updated for better contrast
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
          300: '#93c5fd',
          400: '#60a5fa',
          500: '#3b82f6', // Vibrant blue for better visibility
          600: '#2563eb',
          700: '#1d4ed8',
          800: '#1e40af',
          900: '#1e3a8a',
        ...
        accent: {
          ...
          300: '#fcd34d',
          400: '#fbbf24',
          500: '#f59e0b', // Vibrant orange-yellow
          600: '#d97706',
          700: '#b45309',
          800: '#92400e',
          900: '#78350f',
      ...
      animation: {
        ...
        'scale-in-delayed': 'scaleIn 0.5s ease-out 0.2s both',
